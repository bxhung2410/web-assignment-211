...
<main class="page-main">
      <div class="section-first-screen">
        <div class="first-screen__bg" style="background-image: url(assets/img/pages/contacts/bg8.jpg)"></div>
              ...
              <div>
                <div class="product-full-card__gallery">
                  <div class="product-full-card__gallery-box">
                    <li class="uk-flex uk-flex-center uk-flex-middle"><img src="assets/img/products/skin1.png" alt="skin1"></li>
                  </div>
                  <div class="uk-margin-top" data-uk-slider="finite: true">
                    <ul class="uk-thumbnav uk-slider-items uk-grid uk-grid-small uk-child-width-1-3 uk-child-width-1-4@l">
                      <li data-uk-slideshow-item="0"><a href="#"><img src="assets/img/products/skin1.png" alt="pizza-big"></a></li>
                      <li data-uk-slideshow-item="1"><a href="#"><img src="assets/img/products/skin1.png" alt="pizza-big"></a></li>
                      <li data-uk-slideshow-item="2"><a href="#"><img src="assets/img/products/skin1.png" alt="pizza-big"></a></li>
                      <li data-uk-slideshow-item="3"><a href="#"><img src="assets/img/products/skin1.png" alt="pizza-big"></a></li>
                      <li data-uk-slideshow-item="4"><a href="#"><img src="assets/img/products/skin1.png" alt="pizza-big"></a></li>
                    </ul>
                  </div>
                </div>
              </div>
                          ...
                          <div class="product-item__intro">
                            <div class="product-item__not-active">
                              <div class="product-item__media">
                                <div class="uk-inline-clip uk-transition-toggle uk-light" data-uk-lightbox="data-uk-lightbox"><a href="assets/img/products/skin1.png"><img src="assets/img/products/skin1.png" alt="Skin 1" />
